...
export default function ScorecardViewer({ gameData, controls, isLive }: ScorecardViewerProps) {
	...
	return (
		<div className="space-y-8">
			{/* Game Header */}
			<div className="bg-white dark:bg-primary-800 rounded-xl shadow-sm border border-secondary-200 dark:border-primary-700 p-6">
				<div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
					...
					<div className="flex items-center gap-6 text-sm">
						<div className="text-center">
							<div className="text-secondary-500 dark:text-secondary-400">Away Team</div>
						...
						<div className="text-center">
							<div className="text-secondary-500 dark:text-secondary-400">Home Team</div>
							<div className="font-semibold text-secondary-900 dark:text-secondary-100">
			...
			{/* Game Info Panel */}
			<div className="bg-white dark:bg-primary-800 rounded-xl shadow-sm border border-secondary-200 dark:border-primary-700 p-6">
				<h3 className="text-lg font-semibold text-secondary-900 dark:text-secondary-100 mb-4">Game Information</h3>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
					<div className="space-y-1">
						...
						<div className="text-sm text-secondary-900 dark:text-secondary-100">
							{formatDate(gameData.game_data.game_date_str)}
						</div>
					</div>
					<div className="space-y-1">
						<div className="text-xs font-medium text-secondary-500 dark:text-secondary-400 uppercase tracking-wide">
						...
						<div className="text-sm text-secondary-900 dark:text-secondary-100">{gameData.game_data.location}</div>
					</div>
					<div className="space-y-1">
						<div className="text-xs font-medium text-secondary-500 dark:text-secondary-400 uppercase tracking-wide">
							Innings
						...
						<div className="text-sm text-secondary-900 dark:text-secondary-100">
							{gameData.game_data.inning_list.length}
						</div>
					</div>
					<div className="space-y-1">
						<div className="text-xs font-medium text-secondary-500 dark:text-secondary-400 uppercase tracking-wide">
